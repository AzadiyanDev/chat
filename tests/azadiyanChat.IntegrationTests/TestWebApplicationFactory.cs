    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureServices(services =>
        {
            ...
            var descriptorsToRemove = services.Where(d =>
                d.ServiceType == typeof(DbContextOptions<azadiyanChatDbContext>) ||
                d.ServiceType == typeof(azadiyanChatDbContext) ||
                d.ImplementationType == typeof(azadiyanChatDbContext) ||
            ...
            services.AddSingleton<DbContextOptions<azadiyanChatDbContext>>(_ =>
                new DbContextOptionsBuilder<azadiyanChatDbContext>()
                    .UseInMemoryDatabase(_dbName)
                    .Options);

            services.AddScoped<azadiyanChatDbContext>(sp =>
                new azadiyanChatDbContext(sp.GetRequiredService<DbContextOptions<azadiyanChatDbContext>>()));
