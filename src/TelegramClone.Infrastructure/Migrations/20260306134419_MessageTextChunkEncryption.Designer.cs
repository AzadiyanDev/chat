...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TelegramClone.Domain.Entities.Attachment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("TelegramClone.Domain.Entities.Chat", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TelegramClone.Domain.Entities.ChatParticipant", b =>
                {
            ...
            modelBuilder.Entity("TelegramClone.Domain.Entities.MessageTextChunk", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TelegramClone.Domain.Entities.VoiceNote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TelegramClone.Infrastructure.Identity.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TelegramClone.Infrastructure.Identity.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TelegramClone.Domain.Entities.Message", b =>
                {
                    ...
                    b.HasOne("TelegramClone.Domain.Entities.Message", "ReplyTo")
                        .WithMany()
                        .HasForeignKey("ReplyToId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("TelegramClone.Domain.Entities.User", "Sender")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("TelegramClone.Domain.Entities.VoiceNote", b =>
                {
                    b.HasOne("TelegramClone.Domain.Entities.Message", "Message")
                        .WithOne("VoiceNote")
                        .HasForeignKey("TelegramClone.Domain.Entities.VoiceNote", "MessageId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
