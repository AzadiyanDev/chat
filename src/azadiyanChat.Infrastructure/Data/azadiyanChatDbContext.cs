...
public class azadiyanChatDbContext : IdentityDbContext<ApplicationUser>
{
    public azadiyanChatDbContext(DbContextOptions<azadiyanChatDbContext> options) : base(options) { }
